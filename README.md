# 37-COLLABORATION-WEB-SPACECLOUD

### DIVE SOPT 37기 합동 세미나 데스크탑 웹 3조 스페이스 클라우드

<a href="https://www.gitanimals.org/">
  <img
    src="https://render.gitanimals.org/guilds/781801795311536828/draw"
    width="600"
    height="300"
    alt="gitanimals"
  />
...
<img width="3840" height="2160" alt="image" src="https://github.com/user-attachments/assets/ffa8123d-339f-4197-bf5b-782c1180380a" />

<br />

## ✳️ Convention

ESLint, Prettier, Husky를 통한 구성원들 간의 일관된 코드를 지향합니다. <br />
자세한 내용은 [웹 스페이스 클라우드의 컨벤션 문서](https://glacier-filament-3e4.notion.site/2ab2b94dd63180e4a26fc01884a3b8da?v=2ab2b94dd631800f969b000cfcd8369b)를 참고해 주세요.
